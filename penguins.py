...
if st.button("Predict"):
    ...
    if predictions == 0:
        st.write("The Penguin Specie is: Adelie")
    elif predictions == 1:
        st.write("The Penguin Specie is: Chinstrap")
    else:
        st.write("The Penguin Specie is: Torgesen")
...
st.markdown(
        '`Created by` Jesuyanmife Egbewale | 2023 | \
            `Code:` [GitHub](https://github.com/Yanmi01/The-Penguin-Dataset-EDA-Modelling-and-Deployment/blob/main/Penguin.ipynb)'
            )